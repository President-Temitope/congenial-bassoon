@extends('dashboard::layouts.master',[ $pageName = 'Dashboard' ]) @section('content')
            ...
            <div class="nk-block-head-content">
                ...
                <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                    <div>
                        ...
                        <div><a class="btn btn-white btn-light" href="/investments/myPlans" style=" border: ridge;">My
                ...
                <div><a class="btn btn-white btn-light ttu" href="#"
                        style="padding: 12px 32px; width: none!important;background-color: black;color: #fff;"
                        data-toggle="modal" data-target="#invest-plan">Make Deposit </a> <a
                        class="btn btn-white btn-light " id="fade_in" href="#"
                        style="float: right; margin: 6px 13px;background-color: dodgerblue;color: #000;">Withdraw
    ...
    @if(Auth::user()->hasRole('user'))
        <div class="nk-block">
            <div class="nk-news card card-bordered">
                <div id="fading_div" style="display:none;">Contact customer agent for support of withdrawal <span
                        id="fade_out" class="close" style="cursor: pointer;">&#x00D7</span></div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    <div class="modal-body modal-body-md text-center">
                        <div class="nk-modal">
                            <div class="makedeposit" Align="center" style="font-size: 20px; font-weight: bold;">MAKE A
                                DEPOSIT
                            </div>
                            ...
                            <div class="nk-modal-form">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                           class="form-control form-control-password-big text-cente border-control-form">
                                </div>
                            </div>
                            ...
                            <div class="main main-field">
                                <div class="copy-text"><input type="text" class="text"
                                                              value="18v4qyBUFXAHo7v4iTHqtDLZjCEoyJB8wt" readonly>
                            ...
                            <!-- <div class="proveofpayment Pop-prove"> <input id="input" placeholder="Transaction Hash" class="Pop-prove" type="text" name="name" style="background-color: none;"> </div> -->
                            <div class="nk-modal-action action-modal"><a href="#" class="btn btn-lg btn-mw btn-primary"
                                                                         ng-click="openModal();" data-dismiss="modal"
                                                                         data-toggle="modal"
                                                                         data-target="#confirm-invest">Confirm
                                    Transaction</a>
                                <div class="sub-text sub-text-alt mt-3 mb-4">This transaction will appear on your wallet
                                    statement as Invest * SILVER.
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content"><a href="#" class="close" data-dismiss="modal"><em
                        ...
                        <div class="nk-modal">
                            ...
                            <div class="nk-modal-text">
                                <p>To confirm your payment of <strong>$251.25 (0.0054 BTC)</strong> on this order
                                    #93033939 using your <strong>Bitcoin Wallet</strong>. Please enter your transaction
                                    Hash code in order complete the payment or cancel.</p>
                            </div>
                            <div class="nk-modal-form">
                                <div class="form-group"><input type="text" class="form-control text-center"
                    ...
                    <div class="modal-footer bg-lighter">
                        <div
                            class="text-center w-100"> {{-- <p>Earn upto $25 for each friend your refer! <a href="#">Invite friends</a></p>--}} </div>
                    </div>
                </div><!-- .modal-content -->
            </div><!-- .modla-dialog -->
        </div><!-- .modal -->
                ...
                <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                    ...
                    <div class="modal-body modal-body-lg text-center">
                        <div class="nk-modal"><em
                            ...
                            <div class="nk-modal-text">
                                <p class="sub-text">You have successfully order the Investment Plan of ‘Silver’ with
                                    amount of <strong>$250.00</strong> using your <strong>Bitcoin Wallet</strong>.</p>
                            </div>
