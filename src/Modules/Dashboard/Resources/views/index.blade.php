        ...
        <div class="nk-block-between-md g-3">
            ...
            @if(Auth::user()->hasRole('user'))
                ...
                <div><a class="btn btn-white btn-light ttu" href="#"
                        ...
                        data-toggle="modal" data-target="#invest-plan">Make Deposit </a>
                    <a class="btn btn-white btn-light " id="fade_in" href="#"
                ...
                <div class="modal-content">
                    <div class="modal-body modal-body-md text-center">
                        <div class="nk-modal">
                            ...
                            <div class="proveofpayment Pop-prove"><input id="fileupload" class="" type="file"
                                                                         name="fileupload"
                        ...
                        <div class="nk-modal">
                            ...
                            <div class="nk-modal-text">
                                <p class="sub-text notify-sub-text">You have successfully order the Investment Plan of
                                    ‘Silver’ with amount of <strong>$250.00</strong> using your
                                    <strong>NioWallet</strong>.
                                </p>
                            </div>
                        ...
                        <div class="nk-iv-wg2">
                            ...
                            @if(Auth::user()->hasRole('user'))
                                ...
                                <div class="nk-iv-wg2-cta"><a class="btn btn-primary btn-lg btn-block"
                                                              href="#">Withdraw
                                        Funds</a><a class="btn btn-trans btn-block" href="#">Deposit
                                        Funds</a></div>
                            @endif
                        </div>
                    </div>
                            ...
                            <div class="nk-iv-wg2">
                                ...
                                <div class="nk-iv-wg2-text">
                                    <div class="nk-iv-wg2-amount ui-v2">0 <span
                                            class="sub">0{{count($myActivePlans)}}</span>
                                        Active
                                    </div>
                                    <ul class="nk-iv-wg2-list">
                                        @if(count($myActivePlans) > 0)
