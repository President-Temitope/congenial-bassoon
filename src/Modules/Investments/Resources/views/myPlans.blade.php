...
@section('content')
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools gx-3">
                            <li><a href="#" class="btn btn-primary"><span>Withdraw</span> <em
                                        class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                            <li><a href="/investments" class="btn btn-white btn-light"><span>Invest More</span> <em
                                        class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                        </ul>
                    </div><!-- .nk-block-head-content -->
                </div>
    ...
    @else
        ...
        <blockquote class="blockquote text-center">
            <p class="mb-0">I will tell you how to become rich. Close the doors. Be fearful when others are greedy. Be
                greedy when others are fearful.</p>
            <footer class="blockquote-footer">Warren
                Buffett {{--<cite title="Source Title">Source Title</cite>--}}</footer>
        </blockquote>
    @endif
