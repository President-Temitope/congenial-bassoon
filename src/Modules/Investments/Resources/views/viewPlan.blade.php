@extends('dashboard::layouts.master',[$pageName = 'View Plan']) @section('content') <div class="nk-block-head nk-block-head-lg">
...
<form action="/payments/addPayment" method="post" class="invest-form" enctype="multipart/form-data"> @csrf <div class="nk-block invest-block">
        <div class="row g-gs">
            <div class="col-lg-7">
                <div class="invest-field form-group">
                    <div class="dropdown invest-cc-dropdown"> <a href="#" class="invest-cc-chosen">
                            <div class="coin-item">
                                <div class="coin-icon"> <em class="icon ni ni-offer-fill"></em> </div>
                                <div class="coin-info"> <span class="coin-name">{{$investment->name}}</span> <span class="coin-text">Invest for {{$investment->term_days}} days and get daily profit {{$investment->daily_interest}}%</span> </div>
                            </div>
                        </a> </div><!-- .dropdown -->
                </div><!-- .invest-field -->
                <div class="invest-field form-group">
                    <div class="form-label-group"> <label class="form-label">Or Enter Your Amount</label> </div>
                    <div class="form-control-group">
                        <div class="form-info">USD</div> <input type="number" class="form-control form-control-amount form-control-lg" id="custom_amount" min="{{$investment->min_amount}}" max="{{$investment->max_amount}}" name="custom_amount" placeholder="{{$investment->max_amount}}" onkeyup="changeAmount()" />
                    </div> ` <div class="form-note pt-2">Note: Minimum invest {{$investment->min_amount}} USD and upto {{$investment->max_amount}} USD </div>
                </div><!-- .invest-field -->
                <div class="invest-field form-group">
                    <div class="form-label-group"> <label class="form-label">Choose Payment Method</label> </div> {{-- <input type="hidden" value="wallet" name="iv-wallet" id="invest-choose-wallet">--}}
                    <div class="dropdown invest-cc-dropdown"> <a href="#" class="invest-cc-opt" data-plan="starter">
                            <div class="coin-item">
                                <div class="coin-icon"> <em class="icon ni ni-sign-btc"></em> </div>
                                <div class="coin-info"> <span class="coin-name">BTC Wallet</span> </div>
                            </div>
                        </a> </div><!-- .dropdown -->
                </div><!-- .invest-field -->
                <div class="invest-field form-group">
                    <div class="custom-control custom-control-xs custom-checkbox"> <input type="checkbox" class="custom-control-input" id="checkbox" required> <label class="custom-control-label" for="checkbox">I agree the <a href="#">terms and &amp; conditions.</a></label> </div>
                </div><!-- .invest-field -->
            </div><!-- .col -->
                        ...
                        <div class="nk-iv-wg4-sub">
                            ...
                            <ul class="nk-iv-wg4-overview g-2">
                                <li>
                                    ...
                                    <div class="lead-text">{{$investment->name}}</div> <input type="hidden" name="investment_name" value="{{$investment->name}}"> <input type="hidden" name="investment_id" value="{{$investment->id}}">
                                </li>
                                <li>
                        ...
                        <div class="nk-iv-wg4-sub">
                            <ul class="nk-iv-wg4-list">
                                <li>
                                    ...
                                    <div class="caption-text text-primary">$ <span class="total_amount_to_invest">0</span></div> <input type="hidden" name="total_charge" id="total_charge_input">
                                </li>
                            </ul>
                        </div><!-- .nk-iv-wg4-sub -->
                        <div class="nk-iv-wg4-sub text-center bg-lighter"> <a href="#" class="btn btn-lg btn-primary ttu" data-toggle="modal" data-target="#invest-plan">Confirm &amp; proceed</a> </div><!-- .nk-iv-wg4-sub -->
                    </div><!-- .nk-iv-wg4 -->
                </div><!-- .card -->
            </div><!-- .col -->
        </div><!-- .row -->
                ...
                <div class="modal-content"> <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                    <div class="modal-body modal-body-lg text-center">
                        <div class="nk-modal"> <em class="nk-modal-icon icon icon-circle icon-circle-xxl ni ni-check bg-success"></em>
                            ...
                            <div class="nk-modal-text">
                                <p class="sub-text notify-sub-text">You have successfully order the Investment Plan of <strong>"{{$investment->name}}"</strong>. </p>
                            </div>
                            <div class="nk-modal-action-lg">
                                <ul class="btn-group flex-wrap justify-center g-4">
                                    ...
                                    <li> <button type="submit" class="btn btn-lg btn-mw btn-dim btn-primary"> <em class="icon ni ni-reports"></em><span>Close</span></button> </li>
                                </ul>
                            </div>
                        </div>
                    </div><!-- .modal-body -->
...
</form> @endsection @push('script') <script>
    function copy() {
