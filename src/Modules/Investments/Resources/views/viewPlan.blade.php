@extends('dashboard::layouts.master',[$pageName = 'View Plan']) @section('content')
        ...
        <div class="nk-block invest-block">
            <div class="row g-gs">
                <div class="col-lg-7">
                    <div class="invest-field form-group">
                        <div class="dropdown invest-cc-dropdown"><a href="#" class="invest-cc-chosen">
                                <div class="coin-item">
                                    ...
                                    <div class="coin-info"><span class="coin-name">{{$investment->name}}</span> <span
                                            class="coin-text">Invest for {{$investment->term_days}} days and get daily profit {{$investment->daily_interest}}%</span>
                                    </div>
                                </div>
                            </a></div><!-- .dropdown -->
                    </div><!-- .invest-field -->
                    ...
                    <div class="invest-field form-group">
                        <div class="form-label-group"><label class="form-label">Choose Payment Method</label>
                        </div> {{-- <input type="hidden" value="wallet" name="iv-wallet" id="invest-choose-wallet">--}}
                    ...
                    <div class="card card-bordered ml-lg-4 ml-xl-0">
                        <div class="nk-iv-wg4">
                            ...
                            <div class="nk-iv-wg4-sub text-center bg-lighter"><a href="#"
                                                                                 class="btn btn-lg btn-primary ttu"
                                                                                 data-toggle="modal"
                                                                                 data-target="#invest-plan">Confirm
                                    &amp; proceed</a></div><!-- .nk-iv-wg4-sub -->
                        </div><!-- .nk-iv-wg4 -->
                    </div><!-- .card -->
                </div><!-- .col -->
            </div><!-- .row -->
                    ...
                    <div class="modal-content">
                        <div class="modal-body modal-body-md text-center">
                            <div class="nk-modal">
                                ...
                                <div class="nk-modal-action action-modal"><a href="#"
                    ...
                    <div class="modal-content"><a href="#" class="close" data-dismiss="modal"><em
                        ...
                        <div class="modal-body modal-body-lg text-center">
                            <div class="nk-modal"><em
                                ...
                                <div class="nk-modal-text">
                                    <p class="sub-text notify-sub-text">You have successfully order the Investment Plan
                                        of <strong>"{{$investment->name}}"</strong>. </p>
                                </div>
                                <div class="nk-modal-action-lg">
                                    <ul class="btn-group flex-wrap justify-center g-4">
                                        ...
                                        <li>
                                            <button type="submit" class="btn btn-lg btn-mw btn-dim btn-primary"><em
                                                    class="icon ni ni-reports"></em><span>Close</span></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
