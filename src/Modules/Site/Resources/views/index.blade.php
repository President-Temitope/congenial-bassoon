        ...
        <div class="row about-text justify-content">
            <div class="col-md-6 wow slideInLeft">
                <div class="about-info ">
                    ...
                    <p> On our website, you will encounter links to third party websites. These links may be from us, or they may appear as content generated by other users. These linked sites are not under our control and thus we are not responsible for their actions. Before providing your personal information via any other website, we advise you to examine the terms and conditions of using that website and its privacy policy.<br></p>

                    <p> TheOkxPlatinum © holds about you - This is largely due to the nature of the products and services we provide. Much of the data we collect is in order to facilitate contracts between users, facilitate payments, provide protection for the legitimate users, and meet our legal obligations –<br></p>
...
<script src="assets/js/vendors.min.js"></script> <!-- NB:: vendor jquery always be in between footer | outer footer display none in owl carosoul unless u not using carousel plugin -->
</body> <!-- contributor js  -->
