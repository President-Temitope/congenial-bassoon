...
<head>
    ...
    <link rel="stylesheet" href="asset1/css/regstrAddtionValidateCss/regstrCssValidate.css"> <!-- ==== End REg form css ==== -->
                ...
                <div class="form-container">
                    <div>
                        ...
                        <div class="input-box-wrapper">
                            <!-- Form Starts -->
                            <form method="post" action="{{route('postRegister')}}" id="myForm" class="form-01" novalidate> @csrf <div class="login-form-body  scrollBox">
                                    <div class="field firstName">
                                        <div class="form-gp input-field"> <label for="firstName">First Name</label> <input type="text" name="firstname" id="firstName" onfocusout="validateFirstName()" /> <span class="helper-text"></span> </div>
                                    </div>
                                        ...
                                        <div class="form-gp input-field"> <label for="passord">Password</label> <input type="password" name="password" class="active" id="pass1" onfocusout="validatePassword()" /> <span class="helper-text"></span> <i id="icon1" class="fa fa-eye-slash"></i><br>
                                            <div class="password_strength_box">
                                                <div class="password_strength">
                                                    <div class="meter_strength"> <meter max="4" id="password-strength-meter"></meter> </div>
                                                    <div class="pass-text">
                                    ...
                                    <div class="field password">
                                        <div class="form-gp input-field"> <label for="ConfrimPassword">Confirm Password</label> <input type="password" class="active" id="ConfirmPassword" name="password_confirmation" onfocusout="validateConfirmPassword()" /> <span class="helper-text"></span> <i id="icon" class="fa fa-eye-slash"></i> </div>
                                    </div>
