                ...
                <div>
                    ...
                    <form method="post" action="{{route('postRegister')}}">
                        ...
                        <div class="login-form-body">
                            <div class="form-gp">
                                <label for="exampleInputName1">First Name</label><input type="text" name="firstname"
                                                                                        id="name" required>
                                <input type="hidden" class="form-control" name="ref" value="2170">
                                <input type="hidden" class="form-control" name="sel" value="1a2f">
                                <div class="text-danger"></div>
                            </div>
                            <div class="form-gp"><label for="exampleInputName1">Last Name</label> <input type="text"
                                                                                                         name="lastname"
                                                                                                         id="name"
                                                                                                         required>
                                <div class="text-danger"></div>
                            </div>
                            <div class="form-group input-box"><input class="input-field" name="phone_number" id="phone"
                                                                     placeholder="" type="tel" required>
                                <!-- <label for="email">TELEPHONE</label> -->
                            </div>
                            <div class="form-gp"><label for="exampleInputEmail1">Email address</label> <input
                                    type="email" name="email" required><i class="ti-email"></i>
                                <div class="text-danger"></div>
                            </div>
                            <div class="form-gp"><label for="exampleInputPassword1">Password</label> <input
                                    type="password" name="password" class="active" id="pass1" required=""><i id="icon1"
                                                                                                             class="fa fa-eye-slash"></i>
                                <div class="text-danger"></div>
                                <meter max="4" id="password-strength-meter"></meter>
                                <p id="password-strength-text"></p>
                            </div>
                            <div class="form-gp"><label for="exampleInputPassword2">Confirm Password</label> <input
                                    type="password" class="active" id="pass2" name="password_confirmation" required> <i
                                    id="icon" class="fa fa-eye-slash"></i>
                                <div class="text-danger"></div>
                            </div>
