						...
						<div id="rev_slider_1014_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery">
							<div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
								<ul>
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;color:aliceblue;">	<span class="text-white" style="padding-right:10px;">Earn Up to</span><span class="text-primary">200%</span> ROI
											</div>
										</div>
	...
	<!-- <div class="loading-area">
		...
		<div class="loading-pic">
			<div class="cssload-container">
				<div class="cssload-dot bg-primary"><i class="fa fa-bitcoin" style="color: #000; font-size: 30px;"></i>
				</div>
