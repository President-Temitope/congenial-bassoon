						...
						<div class="clearfix">
							<div class="wt-topbar-right">
								<div class=" language-select pull-right">
									<div class="dropdown">
										<button class="btn dropdown-toggle" type="button" data-toggle="dropdown">Language <span class="caret"></span>
										</button>
...
" alt="{{config('app.name')}}" width="120" height="50">
						...
						<!-- ETRA Nav -->
						<div class="extra-nav">
							<div class="extra-cell"> <a href="#search" class="site-search-btn"><i class="fa fa-search" style="font-size: 24px; color: #fff;"></i></a>
							</div>
						</div>
						<!-- SITE Search -->
						<div id="search" class=""> <span class="close"></span>
							<form role="search" id="searchform" action="http://thewebmax.com/search" method="get" class="radius-xl">
								<div class="input-group">
									<input value="" name="q" type="search" placeholder="Type to search"> <span class="input-group-btn"><button type="button" class="search-btn"><i class="fa fa-search"></i></button></span>
								</div>
							</form>
						</div>
						<!-- MAIN Vav -->
		...
		<div class="page-content" style="background-color: #000;">
					...
					<div class="tp-banner">
						...
						<div id="rev_slider_1014_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery">
							<div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
								<ul>
									<!-- SLIDE 1 -->
									<li data-index="rs-1000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slider2/slide11.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="images/main-slider/slider2/slide11.jpg" alt="" data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina/>
										<!-- LAYERS -->
                                    ...
                                    ]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 12;background-color:rgba(2, 14, 34, 0.9);border-color:rgba(0, 0, 0, 0);border-width:0px;"></div>
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;color:aliceblue;">	<span class="text-white" style="padding-right:10px;">Earn Up to</span><span class="text-primary">200%</span> ROI</div>
										</div>
                                    ...
                                    font-weight: 700;
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">	<span class="text-primary" style="padding-right:10px;">DOUBLE UP</span><span class="text-white">INVEST</span>
											</div>
										</div>
                                    ...
                                    font-weight: bold;
                                    color:#fff;
                                    border-width:0px;"> <span style="font-family: 'Poppins', sans-serif;">Welcome to <span style="color: #ffb631;">&nbsp;CRYPTO BOLT&nbsp;</span> Private &amp; Secure; Invest your Earnings in our Platform, No Investment Fees. Get Up to $250 for referal!
											<br>
									...
									<!-- SLIDE 2 -->
									<li data-index="rs-1001" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slider2/slide22.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
										<!-- MAIN IMAGE -->
										<img src="images/main-slider/slider2/slide11.jpg" alt="" data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina/>
										<!-- LAYERS -->
										<!-- LAYER NR. 1 [ for overlay ] -->
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">	<span class="text-white" style="padding-right:10px;">Crypto</span><span class="text-primary">Invest</span>
											</div>
										</div>
										<!-- LAYER NR. 4 [ for title ] -->
                                    ...
                                    font-weight: 700;
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">	<span class="text-primary" style="padding-right:10px;">Easy & </span><span class="text-white">Secure way</span>
											</div>
										</div>
										<!-- LAYER NR. 5 [ for paragraph] -->
                                    ...
                                    {"delay":"wait","speed":1000,"to":"y:-50px;opacity:0;","ease":"Power2.easeInOut"}
										...
										<!-- LAYER NR. 9 [ for more detail botton ] -->
										<div class="tp-caption tp-resizeme" id="slide-100-layer-9" data-x="['right','right','right','right']" data-hoffset="['360','360','360','360']" data-y="['top','top','top','top']" data-voffset="['300','300','300','300']" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"from":"x:0;y:0;z:0;rX:0;rY:0;rZ:0;sX:0.75;sY:0.75;skX:0;skY:0;opacity:0;","speed":1500,"to":"o:1;","delay":4500,"ease":"Power3.easeOut"},
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 13;">
											<img src="images/main-slider/slider3/map-marker.png" alt="" class="floating">
										</div>
										<!-- LAYER NR. 10 [ for more detail botton ] -->
										<div class="tp-caption tp-resizeme" id="slide-100-layer-10" data-x="['right','right','right','right']" data-hoffset="['240','120','120','120']" data-y="['top','top','top','top']" data-voffset="['490','500','500','500']" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"from":"x:0;y:0;z:0;rX:0;rY:0;rZ:0;sX:0.75;sY:0.75;skX:0;skY:0;opacity:0;","speed":2000,"to":"o:1;","delay":4000,"ease":"Power3.easeOut"},
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 13;">
											<img src="images/main-slider/slider3/map-marker.png" alt="" class="floating">
										</div>
										<!-- LAYER NR. 11 [ for more detail botton ] -->
										<div class="tp-caption tp-resizeme" id="slide-100-layer-11" data-x="['right','right','right','right']" data-hoffset="['80','80','80','80']" data-y="['top','top','top','top']" data-voffset="['250','250','250','250']" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"from":"x:0;y:0;z:0;rX:0;rY:0;rZ:0;sX:0.75;sY:0.75;skX:0;skY:0;opacity:0;","speed":3000,"to":"o:1;","delay":3500,"ease":"Power3.easeOut"},
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 13;">
											<img src="images/main-slider/slider3/map-marker.png" alt="" class="floating">
										</div>
										<!-- LAYER NR. 12 [ for more detail botton ] -->
										<div class="tp-caption tp-resizeme" id="slide-100-layer-12" data-x="['right','right','right','right']" data-hoffset="['70','70','70','70']" data-y="['top','top','top','top']" data-voffset="['380','380','380','380']" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"from":"x:0;y:0;z:0;rX:0;rY:0;rZ:0;sX:0.75;sY:0.75;skX:0;skY:0;opacity:0;","speed":3500,"to":"o:1;","delay":3000,"ease":"Power3.easeOut"},
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 13;">
											<img src="images/main-slider/slider3/map-marker.png" alt="" class="floating">
										</div>
									</li>
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">	<span class="text-primary" style="padding-right:10px;">Grow</span><span class="text-white">with us</span>
											</div>
										</div>
										<!-- LAYER NR. 4 [ for title ] -->
                                    ...
                                    font-weight: 700;
                                    border-width:0px;">
											<div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">	<span class="text-white" style="padding-right:10px;">Earn with us </span><span class="text-primary"></span>
											</div>
										</div>
										<!-- LAYER NR. 5 [ for paragraph] -->
                                    ...
                                    ">
										...
										<!-- LAYER NR. 8 [ for more detail botton ] -->
										<div class="tp-caption tp-resizeme" id="slide-101-layer-8" data-x="['right','right','right','right']" data-hoffset="['279','279','279','279']" data-y="['top','top','top','top']" data-voffset="['180','180','180','180']" data-frames='[{"from":"x:-100;y:0;z:0;rX:0;rY:0;rZ:0;sX:0.75;sY:0.75;skX:0;skY:0;opacity:0;","speed":1500,"to":"o:1;","delay":3000,"ease":"Power3.easeOut"},
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' style="z-index: 13;">
			...
			<div id="bitcoin-price" class="section-full home-about-section p-tb80 bg-no-repeat bg-bottom-right bg-gray" style="background-image:url(images/background/bg-coin.png);background-color: #000;">
				<div class="container">
					<div class="row">
						<div class="col-md-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
							...
							<script type="text/javascript" async="" src="https://widgets.cryptocompare.com/serve/v2/coin/chart?fsym=BTC&amp;tsym=USD&amp;period=1M&amp;app=local"></script>
						...
						<div class="col-md-6">
							<div class="p-b20 text-left"> <span class="wt-title-subline font-16 text-gray-dark m-b15  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s">What is bitcoin</span>
								<h2 class="text-uppercase wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s">New Currency Bitcoin</h2>
			...
			<div class="section-full bg-white p-tb90 " style="background-color: #000!important;">
				<div class="container">
					<!-- TITLE START-->
					<div class="section-head text-center">	<span class="wt-title-subline font-16 text-gray-dark m-b15 wow slideInUp">Buy and Sell Bitcoin</span>
    ...
    font-family: Calibri,sans-serif,serif,EmojiFont;
    font-size: 15px;
" class="ex wow slideInUp">Experts have different opinions about the future of bitcoin, there is nothing to worry about investing in bitcoin as it is one of the best ways to make huge profits asof today.</p>
					</div>
					<!-- TITLE END-->
					<div class="section-content hover-block-outer" data-toggle="tab-hover">
						<div class="row">
							<div class="col-md-4 col-sm-12 m-b30  p-t30">
								<div class="wt-icon-box-wraper right p-a20 wow slideInUp" data-target="#tab1" data-toggle="tab">
									<div class="icon-md text-primary"> <span class="icon-cell  text-primary"><img src="images/icon/pick-17.png" alt=""></span>
									</div>
    ...
    font-family: Calibri,sans-serif,serif,EmojiFont;
    padding: 9px;
">Stop loss and take profit orders will help secure your investment. The system will automatically execute trades to realise gains.</p>
									</div>
								</div>
								<div class="wt-icon-box-wraper right p-a20 wow slideInUp" data-target="#tab2" data-toggle="tab">
									<div class="icon-md text-primary"> <span class="icon-cell  text-primary"><img src="images/icon/pick-29.png" alt=""></span>
									</div>
									<div class="icon-content">
								...
								<div class="wt-icon-box-wraper right p-a20 wow slideInUp" data-target="#tab3" data-toggle="tab">
									<div class="icon-md text-primary"> <span class="icon-cell  text-primary"><img src="images/icon/pick-28.png" alt=""></span>
									</div>
									<div class="icon-content">
    ...
    font-size: 16px;
    font-family: Calibri,sans-serif,serif,EmojiFont;
">Purchase asset depends on agreed item upon price. The purchase will continue automatically until you cancel the service.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-12 m-b30  p-t30">
								<div class="wt-icon-box-wraper left p-a20  wow slideInUp" data-target="#tab4" data-toggle="tab">
									<div class="icon-md text-primary"> <span class="icon-cell  text-primary"><img src="images/icon/pick-19.png" alt=""></span>
									</div>
									<div class="icon-content">
...
">We help you identifying your financial goals and converting them building a plan.</p>
								...
								<div class="wt-icon-box-wraper left p-a20 wow slideInUp" data-target="#tab5" data-toggle="tab">
									<div class="icon-md text-primary"> <span class="icon-cell  text-primary"><img src="images/icon/pick-12.png" alt=""></span>
									</div>
									<div class="icon-content">
...
">We help you manage your Risk.</p>
								...
								<div class="wt-icon-box-wraper left p-a20 wow slideInUp" data-target="#tab6" data-toggle="tab">
									<div class="icon-md text-primary"> <span class="icon-cell  text-primary"><img src="images/icon/pick-38.png" alt=""></span>
									</div>
									<div class="icon-content">
...
">Make transfer anywhere in the world via wallet or BITcoin ATM if available in your country.</p>
    ...
    font-size: 15px;
    color: #ccc;
" class="invest&learn wow fadeInUp">Learning about bitcoin investment and making profits is very easy. Using great platforms like Cryptobolt private &amp; Secure, it very easy for new investors to learn and understand the hidden bitcoin secrets. It takes considerably less time compared to other investments platforms.</p>
					</div>
					<!-- TITLE END-->
					<div class="section-content no-col-gap">
						<div class="row">
							...
							<div class="col-md-4 col-sm-4 step-number-block">
								<div class="wt-icon-box-wraper  p-a30 center bg-white m-a5 wow fadeInUp" data-wow-duration="2s" data-wow-delay="1s">
									...
									<div class="icon-content ">
										...
										<p style="color: #000;">Create CRYPTO BOLT Account for free. No credit card information needed. Once your Registration is accepted, It's quite easy & you'll gain access to all our live investment opportunities, as well as be able to start raising investment.</p>
							...
							<!-- COLUMNS 2 -->
							<div class="col-md-4 col-sm-4 step-number-block">
								<div class="wt-icon-box-wraper  p-a30 center bg-secondry m-a5 wow fadeInUp" data-wow-duration="2s" data-wow-delay="2s">
							...
							<!-- COLUMNS 3 -->
							<div class="col-md-4 col-sm-4 step-number-block">
								<div class="wt-icon-box-wraper  p-a30 center bg-white m-a5 wow fadeInUp" data-wow-duration="2s" data-wow-delay="3s">
									<div class="icon-lg text-primary m-b20">
										<a href="#" class="icon-cell">
			...
			<div id="about-us" class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url(images/background/bg-1.jpg);">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="wt-box graph-part-right text-white wow fadeInUp">	<strong class="text-uppercase title-first"><a class="header-logo">
								...
								<div class="testimonial-5 wow fadeInDown" data-wow-duration="2s" data-wow-delay="1s">
									...
									<div class="testimonial-text clearfix">
										...
										<div class="testimonial-detail clearfix"> <strong class="testimonial-name">Clara Dandrea</strong>
											<span class="testimonial-position text-primary p-t10"><span class="fa fa-instagram" style=" position: relative; right: 4px; top: 1px;"> </span><a href="https://www.instagram.com/">@claradandreadavies</a>
											</span>
										</div>
									</div>
								</div>
								...
								<div class="testimonial-5 wow fadeInDown" data-wow-duration="2s" data-wow-delay="1s">
									...
									<div class="testimonial-text clearfix">
										...
										<div class="testimonial-detail clearfix"> <strong class="testimonial-name">Danny F. Michaels</strong>
											<span class="testimonial-position text-primary p-t10"><span class="fa fa-instagram" style=" position: relative; right: 4px; top: 1px;"></span><a href="https://www.instagram.com/">@dannyfmichael</a>
										</div>
									</div>
								</div>
							</div>
							<div class="item">
								<div class="testimonial-5 wow fadeInDown">
									...
									<div class="testimonial-text clearfix">
										...
										<div class="testimonial-detail clearfix"> <strong class="testimonial-name">Eva Brentford
                                        <span class="testimonial-position text-primary p-t10"><span class="fa fa-instagram" style=" position: relative; right: 4px; top: 1px;"></span><a href="https://www.instagram.com/" style="text-transform: initial;font: icon;
">@evabrentford</a>
                        ...
                        <div class="item">
                            <div class="testimonial-5">
                                ...
                                <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph"> <span class="fa fa-quote-left text-primary"></span>
                                        <p style="font-weight: 100;">Contacting support was simple and easy. I was surprised by how quickly they actually get back to me.</p>
                                    </div>
                                    <div class="testimonial-detail clearfix"> <strong class="testimonial-name">Kimberly K. Kingsley</strong>
											<span class="testimonial-position text-primary p-t10"><span class="fa fa-instagram" style=" position: relative; right: 4px; top: 1px;"></span><a href="https://www.instagram.com/">@__kimberlykimmy</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
							<div class="widget widget_services">
								...
								<ul>
									...
									<li>
										<button id="modal-btn" class="button" data-target="#myModal" data-toggle="modal" data-backdrop="static" data-keyboard="false" style="background:transparent;border:none;">Terms &amp; Condition</button>
									...
									<div class="elementor-element elementor-element-db58fad elementor-widget__width-auto elementor-view-default elementor-widget elementor-widget-icon" data-id="db58fad" data-element_type="widget" data-widget_type="icon.default">
										<div class="elementor-widget-container">
											<div class="elementor-icon-wrapper">
												<div class="elementor-icon">	<i aria-hidden="true" class="fas fa-exclamation-triangle"></i>	
												</div>
											</div>
										</div>
									</div>
									<div class="elementor-element elementor-element-f9fd469 elementor-widget elementor-widget-text-editor" data-id="f9fd469" data-element_type="widget" data-widget_type="text-editor.default">
										<div class="elementor-widget-container">
											<div class="elementor-text-editor elementor-clearfix">
												<p style="
    width: 332px;
">Dealing with financial instruments involves significant risk and can result in the loss of your capital when you do not adhere to the instructions provided by your trader. You should not spend more than you can afford to lose and should ensure that you fully understand the risks involved. Using leveraged products may not be suitable for everyone. Before you use these products, please take into consideration your level of experience, financial objectives and seek independent financial advice if necessary. It is the responsibility of the Client to ascertain whether he/she is permitted to use the services of the CRYPTO BOLT © brand based on the legal requirements in his/her country of residence. Click here to read CRYPTO BOLT©’s <a style="font-weight: 800;" href="{{asset('privacy-policy.blade.php">PRIVACY POLICY</a> 
												</p>
											</div>
										</div>
									</div>
			...
			<div class="modal-dialog modal-sm">
				...
				<div class="modal-content">
					...
					<div class="modal-body p-a30">
						<form id="log-form" method="POST" action="{{ route('login') }}">@csrf
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-user cus-icon"></i></span>
									<input id="email" placeholder="Email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>@error('email') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-eye cus-icon"></i></span>
									<input id="password" placeholder="Password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">@error('password') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body p-a30">
						<form id="reg-form" method="POST" action="{{route('register')}}">@csrf
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-user cus-icon" style="font-size: 15px;!important"></i></span>
									<input id="firstname" type="text" placeholder="Firstname" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" required autocomplete="firstname" autofocus>@error('firstname') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-user cus-icon" style="font-size: 15px;!important"></i></span>
									<input id="lastname" type="text" placeholder="Lastname" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" required autocomplete="lastname" autofocus>@error('firstname') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-envelope cus-icon" style="font-size: 15px;!important"></i></span>
									<input id="email" placeholder="Email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>@error('email') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							...
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-key cus-icon" style="font-size: 15px;"></i></span>
									<input id="confirm-password" placeholder="Confirm Password" type="password" class="form-control @error('password-confirm') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password">@error('password-confirm') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-btc cus-icon" style="font-size: 15px;"></i></span>
									...
									</select>@error('cryptocurrency') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
							<div class="form-group">
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-wallet cus-icon" style="font-size: 15px;"></i></span>
									<input id="wallet_address" placeholder="Wallet address" type="text" class="form-control @error('wallet_address') is-invalid @enderror" name="wallet_address" required autocomplete="wallet_address">@error('wallet_address') <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
									@enderror</div>
							</div>
							<button type="submit" class="site-button-secondry text-uppercase btn-block m-b10">Submit</button> <span class="font-12">Already Have an Account? <a href="javascript:;" class="text-primary">Login</a></span>
						</form>
					</div>
					<div class="modal-footer text-center">
						<div class="text-center">
