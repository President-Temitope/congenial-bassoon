...
<div class="page-wraper">
    ...
    <div class="page-content" style="background-color: #000;">
                        ...
                        <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                            <ul>
                                ...
                                <li data-index="rs-1000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slider2/slide11.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
                                        <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;">	<span class="text-white" style="padding-right:10px;">The most</span><span class="text-primary">Secure</span>
                                        </div>
                                    </div>
                                    ...
                                    font-weight: 700;
                                    border-width:0px;">
                                        <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">	<span class="text-primary" style="padding-right:10px;">Crypto</span><span class="text-white">platform</span>
                                        </div>
                                    </div>
                                    ...
                                    font-weight: bold;
                                    color:#fff;
                                    border-width:0px;"> <span style="font-family: 'Poppins', sans-serif;">Welcome to <span style="color: #ffb631;">Cryptobolt</span> Private &amp; Secure; Get Interest % of your Initial Investment in 7days!
											<br>
                                ...
                                <li data-index="rs-1001" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slider2/slide22.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
                                        <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">	<span class="text-white" style="padding-right:10px;">Bitcoin</span><span class="text-primary">Invest</span>
                                        </div>
                                    </div>
                                    <!-- LAYER NR. 4 [ for title ] -->
                                ...
                                <li data-index="rs-1002" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/main-slider/slider2/slide11.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    ...
                                    color: rgb(75, 57, 65);
                                    border-width:0px;">
                                        <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">	<span class="text-primary" style="padding-right:10px;">Bitcoin</span><span class="text-white">Currency</span>
                                        </div>
                                    </div>
                                    <!-- LAYER NR. 4 [ for title ] -->
                                    ...
                                    font-weight: 700;
                                    border-width:0px;">
                                        <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">	<span class="text-white" style="padding-right:10px;">Easy Way</span><span class="text-primary">to Trade</span>
                                        </div>
                                    </div>
                                    <!-- LAYER NR. 5 [ for paragraph] -->
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' style="z-index: 13;">
                                        <img src="images/main-slider/slider3/b-left.png" alt="">
                                    </div>
                                    <!-- LAYER NR. 9 [ for more detail botton ] -->
                                    ...
                                    {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}]' style="z-index: 13;">
                                        <img src="images/main-slider/slider3/b-right.png" alt="">
                                    </div>
                                    <!-- LAYER NR. 10 [ for more detail botton ] -->
                ...
                <div class="ti_wrapper">
                    <div class="ti_slide">
                        <div class="ti_content">
                            ...
                            <div class="ti_news">
                                <a href="#">
                                    <img src="images/coin-icon/DigitalCash.png" alt=""><span>DASH: </span><span>Ƀ 0.05590</span><span class="text-white p-lr5">0.26 %</span>
                                </a>
                            </div>
                            <div class="ti_news">
                                <a href="#">
        ...
        <div id="bitcoin-price" class="section-full home-about-section p-tb80 bg-no-repeat bg-bottom-right bg-gray" style="background-image:url(images/background/bg-coin.png);background-color: #000;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="p-b20 text-left"> <span class="wt-title-subline font-16 text-gray-dark m-b15">What is bitcoin</span>
        ...
        <div class="section-full bg-white p-tb90 " style="background-color: #000!important;">
            <div class="container">
                <!-- TITLE START-->
                <div class="section-head text-center">	<span class="wt-title-subline font-16 text-gray-dark m-b15">Buy and Sell Bitcoin</span>
    ...
    font-family: Calibri,sans-serif,serif,EmojiFont;
    font-size: 15px;
">Experts have different opinions about the future of bitcoin, there is nothing to worry about investing in bitcoin as it is one of the best ways to make huge profits asof today.</p>
                </div>
                <!-- TITLE END-->
...
">Make transfer anywhere in the world via wallet or BITcoin ATM if available in your country.</p>
        ...
        <div class="section-full  p-t80 p-b80 bg-gray" id="how-it-work">
            <div class="container">
                <!-- TITLE START-->
                <div class="section-head text-center">	<span class="wt-title-subline font-16 text-gray-dark m-b15">Three steps bticoin</span>
    ...
    font-size: 15px;
    color: #ccc;
">Learning about bitcoin investment and making profits is very easy. Using great platforms like Cryptobolt private &amp; Secure, it very easy for new investors to learn and understand the hidden bitcoin secrets. It takes considerably less time compared to other investments platforms.</p>
                </div>
                <!-- TITLE END-->
        ...
        <div id="about-us" class="section-full  p-tb80 bg-full-height bg-repeat-x graph-slide-image" style="background-image:url(images/background/bg-1.jpg);">
            <h2 class="text-uppercase" style="text-align: center;">About Us</h2>
        ...
        <section  id="prices" class="section-full pricing  p-t80 p-b80 bg-gray" style="background-image: url(&quot;assets/images/background/;);">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class=" col-xs-12 col-sm-12 col-md-4 price-table wow fadeInUp animated animated" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInUp;">
...
">
            <div class="container">
                <!-- TITLE START -->
                <div class="section-head text-center">	<span class="wt-title-subline font-16 text-gray-dark m-b15">Our Clients</span>
