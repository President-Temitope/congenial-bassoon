@extends('dashboard::layouts.master',[$pageName = 'Plan information'])
@section('content')
    <!-- content @s -->
                ...
                <div class="nk-content-body">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <div class="nk-block-head-sub"><a href="/investments" class="text-soft back-to"><em
                                        class="icon ni ni-arrow-left"> </em><span>My Investment</span></a></div>
                            <div class="nk-block-between-md g-4">
                                <div class="nk-block-head-content">
                                    <h2 class="nk-block-title fw-normal"> - Daily 4.76% for 21 Days</h2>
                                    <div class="nk-block-des">
                                        <p>INV-{{rand(1002,56682)}} <span class="badge badge-outline badge-primary">Running</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="nk-block-head-content">
                                    <ul class="nk-block-tools gx-3">
                                        <li class="order-md-last"><a href="#" class="btn btn-danger"><em
                                                    class="icon ni ni-cross"></em> <span>Cancel this plan</span> </a>
                                        </li>
                                        <li><a href="#" class="btn btn-icon btn-light"><em
                                        ...
                                        <div class="nk-iv-wg3">
                                            <div class="nk-iv-wg3-group flex-lg-nowrap gx-4">
                                                ...
                                                <div class="nk-iv-wg3-sub">
                                                    ...
                                                    <div class="nk-iv-wg3-amount">
                                                        <div class="number">1,643.76 <span
                                                                class="number-up">4.76 %</span></div>
                                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 offset-lg-2">
                                        <div class="nk-iv-wg3 pl-md-3">
                                            <div class="nk-iv-wg3-group flex-lg-nowrap gx-4">
                                                <div class="nk-iv-wg3-sub">
                                                    <div class="nk-iv-wg3-amount">
                                                        <div class="number">4,999.90 <span
                                                                class="number-down">1017.14 <em
                                                                    class="icon ni ni-info-fill" data-toggle="tooltip"
                                                                    data-placement="right"
                                                                    title="tooltip text"></em></span></div>
                                                    </div>
                            ...
                            <div id="schemeDetails" class="nk-iv-scheme-details">
                                ...
                                <ul class="nk-iv-wg3-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="lead-text"><span class="currency currency-usd">USD</span> 2,535.75
                                        </div>
                                    </li>
                                </ul><!-- .nk-iv-wg3-list -->
                                <ul class="nk-iv-wg3-list">
                                    <li>
                                        ...
                                        <div class="lead-text"><span class="currency currency-usd">USD</span> 2,500.00
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sub-text">Daily profit</div>
                                        <div class="lead-text"><span class="currency currency-usd">USD</span> 119.10
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sub-text">Net profit</div>
                                        <div class="lead-text"><span class="currency currency-usd">USD</span> 2,499.90
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sub-text">Total return</div>
                                        <div class="lead-text"><span class="currency currency-usd">USD</span> 4,999.90
                                        </div>
                                    </li>
                                </ul><!-- .nk-iv-wg3-list -->
                                    ...
                                    <div class="card-inner justify-center text-center h-100">
                                        <div class="nk-iv-wg5">
                                            ...
                                            <div class="nk-iv-wg5-ck">
                                                <input type="text" class="knob-half" value="68.9" data-fgColor="#6576ff"
                                                       data-bgColor="#d9e5f7" data-thickness=".06" data-width="300"
                                                       data-height="155" data-displayInput="false">
                                                ...
                                                <div class="nk-iv-wg5-ck-minmax">
                                                    <span>2,500.00</span><span>4,999.90</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-inner justify-center text-center h-100">
                                        <div class="nk-iv-wg5">
                                            <div class="nk-iv-wg5-head">
                                                ...
                                                <div class="nk-iv-wg5-subtitle">Earn so far <strong>1,643.76</strong>
                                                    <span class="currency currency-usd">USD</span></div>
                                            </div>
                                            <div class="nk-iv-wg5-ck sm">
                                                <input type="text" class="knob-half" value="68.9" data-fgColor="#33d895"
                                                ...
                                                <div class="nk-iv-wg5-ck-minmax"><span>0.00</span><span>2,999.90</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-bordered h-100">
                                    <div class="card-inner justify-center text-center h-100">
                                        <div class="nk-iv-wg5">
                                            ...
                                            <div class="nk-iv-wg5-ck sm">
                                                <input type="text" class="knob-half" value="68.9" data-fgColor="#816bff"
                                                       data-bgColor="#d9e5f7" data-thickness=".07" data-width="240"
                                                       data-height="125" data-displayInput="false">
                                                <div class="nk-iv-wg5-ck-result">
                                            ...
                                            <table class="table table-iv-tnx">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tb-col-time tb-col-end"><span
                                                            class="lead-text text-danger">- 2,500.00</span></td>
                                                </tr>
                                                <tr>
...
@push('scripts')
    <script src="{{asset('assets/js/charts/chart-invest.js?ver=2.9.0')}}"></script>
@endpush
