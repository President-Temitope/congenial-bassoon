            ...
            <div class="nk-refwg">
                <div class="nk-refwg-invite card-inner">
                    <div class="nk-refwg-head g-3">
                        ...
                        <div class="nk-refwg-action"><a class="btn btn-primary" href="#">Invite</a>
                        </div>
                    </div>
                    <div class="nk-refwg-url">
                        <div class="form-control-wrap">
                            ...
                            <input class="form-control copy-text" id="refUrl" type="text"
                ...
                <div class="nk-refwg-stats card-inner bg-lighter">
                    <div class="nk-refwg-group g-3">
                        <div class="nk-refwg-name"><h6 class="title">My Referral <em
                                    class="icon ni ni-info" data-placement="right" data-toggle="tooltip"
                                    title="Referral Informations"></em></h6></div>
                        <div class="nk-refwg-info g-3">
                            <div class="nk-refwg-sub">
                                <div class="title">394</div>
                                <div class="sub-text">Total Joined</div>
                        ...
                        <div class="nk-refwg-more dropdown mt-n1 mr-n1"><a class="btn btn-icon btn-trigger"
