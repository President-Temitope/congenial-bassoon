		...
		<div class="row">\
			...
			<div class="col-md-6 col-sm-6 form-group">\
				<div class="select-box">\
					<select id="cur-1" class="form-control" style="width:100%;' + crypt_calc_font_style + '">' + outList("BTC") + '</select>\
				</div>\
			</div>\
			<div class="col-md-6 col-sm-6 form-group">\
				<input id="amount-2" class="form-control" type="text" placeholder="Enter amount" style="width:100%;' + crypt_calc_font_style + '">\
			</div>\
			<div class="col-md-6 col-sm-6 form-group">\
				<div class="select-box">\
					<select id="cur-2" class="form-control" style="width:100%;' + crypt_calc_font_style + '">' + outList("USD") + '</select>\
				</div>\
			</div>\
			</div>\
    </div>');
